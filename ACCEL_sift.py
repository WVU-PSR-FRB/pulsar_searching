...
sifting.short_period = 0.01048576
# Longest period candidates to consider (s)
sifting.long_period = 15.0
# Ignore any candidates where at least one harmonic does exceed this power
sifting.harm_pow_cutoff = 20.0
...
elif len(re.findall("red", inffiles[0])):
    dmstrs_inter = [x.split("_")[-2] for x in inffiles]
    dmstrs = [x.split("DM")[-1] for x in dmstrs_inter]
